...
public class cheattoggler {
	 ...
	 static {
		...
		//ItemStack cheattoggler = hashmapItems.items.put("cheattoggler", cheatToggler);
	}

	// ItemStack cheatTogglerFinished = hashmapItems.items.put("cheattoggler", cheatToggler());
